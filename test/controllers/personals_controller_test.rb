...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { birth: @personal.birth, kana: @personal.kana, name: @personal.name, sex: @personal.sex, user_id: @personal.user_id } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { birth: @personal.birth, kana: @personal.kana, name: @personal.name, sex: @personal.sex, user_id: @personal.user_id } }
